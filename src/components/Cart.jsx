  ...
  return (
    <div 
      ...
      <div
        ...
        className='z-20 relative bg-slate-300 text-slate-900 
        min-w-[400px] md:min-w-[700px] px-10 pt-10 pb-6 rounded border border-slate-600 mb-[10vh]'
      >
        <button 
          onClick={onClose}
        ...
        <ul>
          ...
          :
          <li className='mb-4'>Aucun article dans votre panier.</li>
          }
        </ul>
        <p className='text-xl'>Total du panier : <span className='font-semibold'>
